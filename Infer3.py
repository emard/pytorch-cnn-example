...
# uses PIL instead of cv2
# BUG doesn't output type 2 (all are type 1)
# maybe RGB-BGR conversion needed?
...
def semantic_segmentation(in_file, out_file):
  ...
  #in_img_cv2 = cv2.imread(in_file)
  #in_img = Image.fromarray(cv2.cvtColor(in_img_cv2, cv2.COLOR_BGR2RGB))
